...
| 4     | [Element Implementations](phase-elements.md) | ~450 | ✅ Done (33 implemented, including V4L2 Sink) + planned additions |
...
| Elements (4) | ✅ Done + planned additions | 33 elements implemented; HTTP Source and V4L2 Sink done |
